...
public class CeoGUI extends JFrame {
	...
	private JTextField textContraseñaUser;
	private JTextField textRepContraUser;
	...
	private JTextField txtElimInmueble;
	private JTextField txtElimCliente;
	...
	public CeoGUI() {
		...
		tabbedPane.setBounds(10, 11, 915, 495);
		...
		scrollPane.setBounds(10, 11, 890, 323);
		...
		comboBox1.setBounds(26, 368, 158, 22);
		...
		btnNewButton_9.setBounds(748, 433, 152, 23);
		...
		JLabel lblNewLabel_32 = new JLabel("Eliminar Inmuble");
		lblNewLabel_32.setBounds(52, 84, 118, 14);
		panel_5.add(lblNewLabel_32);

		JLabel lblNewLabel_33 = new JLabel("Eliminar Cliente");
		lblNewLabel_33.setBounds(52, 145, 103, 14);
		panel_5.add(lblNewLabel_33);

		JLabel lblNewLabel_34 = new JLabel("Eliminar Contrato Compra VEnta");
		lblNewLabel_34.setBounds(52, 208, 194, 14);
		panel_5.add(lblNewLabel_34);

		JLabel lblNewLabel_35 = new JLabel("Eliminar Contrato Alquiler");
		lblNewLabel_35.setBounds(52, 273, 156, 14);
		panel_5.add(lblNewLabel_35);

		txtElimInmueble = new JTextField();
		txtElimInmueble.setBounds(276, 81, 200, 20);
		panel_5.add(txtElimInmueble);
		txtElimInmueble.setColumns(10);

		txtElimCliente = new JTextField();
		txtElimCliente.setBounds(276, 139, 200, 20);
		panel_5.add(txtElimCliente);
		txtElimCliente.setColumns(10);

		txtElimContratoCompraVenta = new JTextField();
		txtElimContratoCompraVenta.setBounds(276, 205, 200, 20);
		panel_5.add(txtElimContratoCompraVenta);
		txtElimContratoCompraVenta.setColumns(10);

		txtElimContratoAlquiler = new JTextField();
		txtElimContratoAlquiler.setBounds(276, 270, 200, 20);
		panel_5.add(txtElimContratoAlquiler);
		txtElimContratoAlquiler.setColumns(10);

		JLabel lblNewLabel_37 = new JLabel("Ingrese la cedula ");
		lblNewLabel_37.setBounds(326, 114, 135, 14);
		panel_5.add(lblNewLabel_37);

		JLabel lblNewLabel_38 = new JLabel("Ingrese el id contrato compra venta");
		lblNewLabel_38.setBounds(286, 180, 214, 14);
		panel_5.add(lblNewLabel_38);

		JLabel lblNewLabel_39 = new JLabel("Ingrese el id contrato alquiler");
		lblNewLabel_39.setBounds(305, 245, 183, 14);
		panel_5.add(lblNewLabel_39);

		JLabel lblNewLabel_40 = new JLabel("Ingrese el padron");
		lblNewLabel_40.setBounds(326, 56, 135, 14);
		panel_5.add(lblNewLabel_40);

		JButton btnNewButton_8 = new JButton("Eliminar");
		btnNewButton_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				String cedula= txtElimCliente.getText();
				System.out.println(cedula);
				String Inmueble= txtElimInmueble.getText();
				...
				if (cedula.isEmpty()) {
					if (Inmueble.isEmpty()) {
						...
						datos.setInmuebleElim(Inmueble);
						MisMetodos.eliminarInmueble(datos);
						
					}
				} else {
					
						datos.setCedulaElim(cedula);
						MisMetodos.eliminarCliente(datos);
		...
		JPanel UsuC = new JPanel();
		tabbedPane.addTab("Crear Usuario", null, UsuC, null);
		UsuC.setLayout(null);

		textNombreUser = new JTextField();
		textNombreUser.setBounds(244, 64, 86, 20);
		UsuC.add(textNombreUser);
		textNombreUser.setColumns(10);

		textContraseñaUser = new JTextField();
		textContraseñaUser.setBounds(244, 117, 86, 20);
		UsuC.add(textContraseñaUser);
		textContraseñaUser.setColumns(10);

		textRepContraUser = new JTextField();
		textRepContraUser.setBounds(244, 171, 86, 20);
		UsuC.add(textRepContraUser);
		textRepContraUser.setColumns(10);

		JLabel lblNewLabel_7 = new JLabel("Nombre del Usuario");
		lblNewLabel_7.setBounds(94, 67, 99, 14);
		UsuC.add(lblNewLabel_7);

		JLabel lblNewLabel_10 = new JLabel("contraseña Usuario");
		lblNewLabel_10.setBounds(94, 120, 108, 14);
		UsuC.add(lblNewLabel_10);

		JLabel lblNewLabel_8 = new JLabel("Repite la contraseña");
		lblNewLabel_8.setBounds(94, 174, 99, 14);
		UsuC.add(lblNewLabel_8);

		JComboBox comboBoxR = new JComboBox();

		comboBoxR.setModel(new DefaultComboBoxModel(new String[] {"CEO", "GERENTE", "ADMINISTRADOR"}));
		comboBoxR.setBounds(415, 63, 162, 22);
		UsuC.add(comboBoxR);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String nombreUsuario = textNombreUser.getText();
				String contraseña = textContraseñaUser.getText();
				String repetirContraseña = textRepContraUser.getText();

				if (validaciones.validarNombreUsuario(nombreUsuario)) {
					if (validaciones.validarContraseña(contraseña)) {
						if (contraseña.equals(repetirContraseña)) {

							datos.setUser(nombreUsuario);
							datos.setContraseña(contraseña);
							datos.setRol(comboBoxR.getSelectedItem().toString());

							datos.nuevoUsuario(datos);
							textNombreUser.setText("");
							textContraseñaUser.setText("");
							textRepContraUser.setText("");
							...
							textContraseñaUser.setText("");
							textRepContraUser.setText("");
							textContraseñaUser.requestFocus();
						}
					} else {
						JOptionPane.showMessageDialog(null, "Datos no válidos. Verifica la contraseña.",
								"Error de Validación", JOptionPane.ERROR_MESSAGE);
						textContraseñaUser.setText("");
						textRepContraUser.setText("");
						textContraseñaUser.requestFocus();
					...
					JOptionPane.showMessageDialog(null, "Datos no válidos. Verifica el nombre de usuario.",
							"Error de Validación", JOptionPane.ERROR_MESSAGE);
					textNombreUser.setText("");
					textNombreUser.requestFocus();
				}
		...
		btnNewButton.setBounds(420, 320, 89, 23);
		UsuC.add(btnNewButton);



		JLabel lblNewLabel_36 = new JLabel("Elige el rol del nuevo usuariol");
		lblNewLabel_36.setBounds(432, 38, 145, 14);
		UsuC.add(lblNewLabel_36);
	}
}
